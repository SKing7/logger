...
module.exports = {
    ...
    im: function (timingDb, data) {
        ...
        _.forEach(timing, function (v, k) {
            if (k.indexOf('c_') === 0) {
                var exName = k.substr(2);
                timingDb.im_c = timingDb.im_c || {};
                timingDb.im_c[index] = timingDb.im_c[index] || {};
                timingDb.im_c[index][exName] = timingDb.im_c[index][exName] || [];
                timingDb.im_c[index][exName].push(v);
