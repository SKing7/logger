...
module.exports = {
    ...
    ex: function (db, poll) {
        ...
        var totalRadio = { 
            ...
            loc_ios_ip: avgByState(registerMap.loc, 'loc_ios_other', 'f', '^loc_ios'),
            loc_ios_other_failure: avgByState(registerMap.loc, 'loc_ios_ip', 'f', '^loc_ios'),
        };
        console.log('百分比计算结果：', totalRadio);
        ...
        function handleHub(dset, type, targetObj) {
            ...
            //数量根据type进行聚合
                ...
                registerMap.loc = registerMap.loc || {};
